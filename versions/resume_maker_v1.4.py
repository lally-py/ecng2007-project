...
# prompts added but not functioning correctly
# for visual part let it be read back to the user
# update chatgpt promopt 
# add new ke words, redo, accept, finish, stop, stop recording, skip question, skip for voice walkthrough
# 
...
def reword_text(text, question):
    try:
        ...
        prompt = reword_prompts.get(question, "The following text is from a speech to text detection system, if the text does not align with the question meaning the speech to text was very innacurate and does not relate to the field that it should go into please return as best as possible a response that follows the question asked. Otherwise reword for better grammar and professional tone. It is meant for a resume, so please keep it concise and respond in one sentence:\n\n" + text
        ) 
...
try:
    manual_icon = ctk.CTkImage(Image.open("uni_projects/2007_grp_prj/icons/manual_icon.png"), size=(20, 20))
    voice_icon = ctk.CTkImage(Image.open("uni_projects/2007_grp_prj/icons/voice_icon.png"), size=(20, 20))
    start_icon = ctk.CTkImage(Image.open("uni_projects/2007_grp_prj/icons/start_icon.png"), size=(20, 20))
    stop_icon = ctk.CTkImage(Image.open("uni_projects/2007_grp_prj/icons/stop_icon.png"), size=(20, 20))
    next_icon = ctk.CTkImage(Image.open("uni_projects/2007_grp_prj/icons/next_icon.png"), size=(20, 20))
    prev_icon = ctk.CTkImage(Image.open("uni_projects/2007_grp_prj/icons/prev_icon.png"), size=(20, 20))
    save_icon = ctk.CTkImage(Image.open("uni_projects/2007_grp_prj/icons/save_icon.png"), size=(20, 20))
    skip_icon = ctk.CTkImage(Image.open("uni_projects/2007_grp_prj/icons/skip_icon.png"), size=(20, 20))
    accept_icon = ctk.CTkImage(Image.open("uni_projects/2007_grp_prj/icons/accept_icon.png"), size=(20, 20))
    redo_icon = ctk.CTkImage(Image.open("uni_projects/2007_grp_prj/icons/redo_icon.png"), size=(20, 20))
    add_more_icon = ctk.CTkImage(Image.open("uni_projects/2007_grp_prj/icons/add_more_icon.png"), size=(20, 20))
except Exception as e:
...
def show_start_page():
    ...
    try:
        logo_image = ctk.CTkImage(Image.open("uni_projects/2007_grp_prj/icons/logo.png"), size=(100, 100))
