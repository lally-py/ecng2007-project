...
# update rewording prompt (maybe make each questions prompt unique)
...
def reword_text(text):
    try:
        ...
        prompt = f"Reword the following for better grammar and professional tone. It is meant for a resume, so please keep it concise:\n\n{text}"
