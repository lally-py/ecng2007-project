...
# add back button so that when you click on either manual or voice assisted gui you can go back to the starting screen
...
def clear_data():
    ...
    global current_question, transcribed_responses
