...
# allow user to select location for files to be stored, default to a folder in the users download folder named VRM (program name) -- undone
# update help menu to say where the files are defaulted too -- undone
